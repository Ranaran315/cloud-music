...
export { default as NoFullScreen } from './no-full-screen.vue'
...
export { default as SubScribed } from './subscribed.vue'
export { default as Phone } from './phone.vue'
export { default as QR } from './qr.vue'
export { default as ListLoop } from './list-loop.vue'
export { default as ShufflePlay } from './shuffle-play.vue'
export { default as SingalLoop } from './singal-loop.vue'
